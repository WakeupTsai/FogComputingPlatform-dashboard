 ...
 */
/** phstsai **/
export const locationLabelComponent= {
  bindings: {
    'locationlabels': '=',
  },
  controller: LocationLabelsController,
  controllerAs: 'locationLabelsCtrl',
  templateUrl: 'common/components/locationlabel/locationlabels.html',
