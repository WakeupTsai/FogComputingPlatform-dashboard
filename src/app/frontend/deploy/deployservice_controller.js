 ...
 * @final
 */
export default class DeployServiceFromFileController {
  /**
  ...
  deploytemperature(validate = true) {
    if (this.form.$valid) {

      /** @type {!backendApi.AppDeploymentFromFileSpec} */
      let deploymentSpec = {
        name: this.file.name,
        content: "apiVersion: v1\nkind: ReplicationController\nmetadata: \n  name: temperature\n  namespace: kube-system\n  labels: \n    name: temperature\nspec:\n  replicas: 1\n  selector:\n    name: temperature\n  template:\n    metadata:\n      labels:\n        name: temperature\n    spec:\n      containers:\n      - name: temperature\n        image: wakeup706/rpi-temperature-mqtt\n        env:\n        - name: MQTT_HOST\n          value: 140.114.79.70\n        - name: MQTT_TOPIC\n          value: \"home/labTemp\"\n        securityContext:\n          privileged: true\n      nodeSelector:\n        device: \"1\"\n",
        validate: validate,
      };
