 ...
 */
const i18n = {
  /** @type {string} @desc Label 'Stateful Sets' that appears as a breadcrumbs on the action bar. */
  MSG_BREADCRUMBS_STATEFUL_SETS_LABEL: goog.getMsg('Stateful Sets'),
};

/**
 * Config state object for the Stateful Set list view.
 *
...
export const config = {
  ...
  data: {
    [breadcrumbsConfig]: {
      'label': i18n.MSG_BREADCRUMBS_STATEFUL_SETS_LABEL,
  ...
  views: {
    '': {
      ...
      controllerAs: '$ctrl',
      templateUrl: 'statefulset/list/list.html',
    },
  },
};
 ...
 * @ngInject
 */
export function statefulSetListResource($resource) {
